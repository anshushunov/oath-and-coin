 ...
 */
const SHIPPED_CONTENT_VERSION = 'ec03d8819bdf9695';
 ...
 * again for the same reason and by the same hand: `schema_version: 5` and a `capability`
 ...
 * does.
 */
const SCREEN_EMPTY_CONTENT_VERSION = '2812fbd035cb6d06';
