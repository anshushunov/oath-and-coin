 ...
 *
 * Причина — готовая строка, а не ключ: кит не знает о каталоге ничего, кроме того, что
 * ему дали, и разрешать ключи остаётся экрану, у которого каталог есть (`useText`).
 *
