...
**не переснимались** — они остаются в записи такими, какими были опубликованы, и
эта запись говорит, чем они на самом деле являются.
...
| Внешнее ревью | по швам: девять внутренних ревью пройдено, внешнее ревью сегмента — на Task 18 |
