...
логическое время, фокусный контракт и SHA-256 над всем перечисленным;
`created_at` лежит **вне** суммы, чтобы повторное сохранение одного состояния не
выглядело как другое сохранение. Девять кодов отказа, по тесту на строку таблицы.
