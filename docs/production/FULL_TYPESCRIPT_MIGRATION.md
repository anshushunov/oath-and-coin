...
| `migration/04-ui` | 11–15 | обязательно (Task 15) — фактически несколькими PR, как сегмент 3: Task 11 (PR #17, ревью пройдено, §11.2), Task 12 (PR #19, ревью пройдено, §11.4), Task 13 (PR #21, ревью пройдено, §11.6), Tasks 14–15 следующими; см. §12.1 |
