...
| `migration/03-core` | 6–10 | обязательно (Task 10) — фактически двумя PR: Tasks 6–8 (PR #13, ревью пройдено, §7.7) и Tasks 9–10 отдельной ветвью; см. §8.2 |
...
| Осталось в сегменте | Task 9 (стоп-гейт), Task 10 (обязательное внешнее ревью) — отдельной ветвью от обновлённого `main` |
